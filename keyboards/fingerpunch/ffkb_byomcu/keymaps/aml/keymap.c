...
[_QWERTY] = LAYOUT_ffkb(
  ...
  CTRLTB,  KC_A,        KC_S,         KC_D,         KC_F,         KC_G,         KC_H,    KC_J, 		   KC_K, 		 KC_L, 		   KC_SCLN,  KC_QUOT,
  KC_LSFT, KC_Z,         KC_X,         KC_C,         KC_V,         KC_B,         KC_N,    KC_M,         KC_COMM,      KC_DOT,       KC_SLSH,          KC_RSFT,
                       _______,      LOWER,        KC_ENT,       KC_LGUI,        KC_RALT,   KC_SPC,       RAISE,       KC_HOME,
                                                                        LALT(KC_TAB)
),
...
[_RAISE] = LAYOUT_ffkb(
  ...
  KC_HOME, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_PGUP,       _______, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
  _______, _______, KC_PGDN, KC_PGUP, _______, KC_PGDN,       _______, _______, _______, _______, _______, _______,
...
[_LOWER] = LAYOUT_ffkb(
  ...
  _______, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, _______,      _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
  _______, KC_CAPS, KC_BTN2, KC_BTN3, KC_BTN1, _______,      _______, _______, _______, KC_PIPE,  KC_DQT, _______,
                    _______, _______, _______, _______,      _______, _______, _______, _______,
                                                      _______
),
...
[_FN] =  LAYOUT_ffkb(
  _______, KC_F1, KC_F4, KC_F7, KC_F10, KC_F13,       _______,   _______,   _______,   _______,    _______,  _______,
  _______, KC_F2, KC_F5,  KC_F8, KC_F11, KC_F14,      _______,   _______,   _______,   _______,    _______, _______,
  _______, KC_F3, KC_F6,  KC_F9, KC_F12, KC_F15,           _______,  _______,  _______, _______,  _______,  QK_BOOT,
                     _______, _______, _______, _______,           _______, _______, _______, _______,
                                                         _______
),

[_MOUSE] =  LAYOUT_ffkb(
  _______, _______, DPI_DN, DPI_FINE, DPI_UP, _______,       _______,   _______,   _______,   _______,    _______,  _______,
  _______, KC_BTN4, KC_BTN2,  KC_BTN3, KC_BTN1, _______,      _______,   _______,   _______,   _______,    _______, _______,
  _______, LCTL(KC_X), LCTL(KC_C),  LCTL(KC_V), _______, _______,           _______,  _______,  _______, _______,  _______,  _______,
                     _______, _______, _______, _______,           _______, _______, _______, _______,
                                                         _______
)
};
